...
joint.shapes.devs.Model = joint.shapes.basic.Generic.extend(_.extend({}, joint.shapes.basic.PortsModelInterface, {
    ...
    markup: '<g class="rotatable"><g class="scalable"><rect class="body"/><g class="deleteTool"/>,</g><text class="label"/><text class="labelTrigger"/><text class="labelAction"/><g class="inPorts"/><g class="outPorts"/></g>',
    ...
    defaults: joint.util.deepSupplement({
        ...
        attrs: {
			...
			'.labelTrigger': { text: '', 'ref-x': .5, 'ref-y': 20, ref: '.body', fill: '#000000' },
			'.labelAction': { text: '', 'ref-x': .5, 'ref-y': 20, ref: '.body', fill: '#000000' },
            '.inPorts .port-label': { x:-15, dy: 4, 'text-anchor': 'end', fill: '#000000' },
            '.outPorts .port-label':{ x: 35, dy: 25, fill: '#000000' }
...
joint.shapes.devs.ModelView = joint.dia.ElementView.extend(joint.shapes.basic.PortsViewInterface,joint.plugins.TooledViewInterface);
...
joint.shapes.devs.TooledModel = joint.shapes.devs.Model.extend( _.extend({}, joint.plugins.TooledModelInterface, {
    ...
    markup: '<g class="rotatable"><g class="scalable"><rect class="body"/></g><text class="label"/><g class="inPorts"/><g class="outPorts"/><text class="labelTrigger"/><text class="labelAction"/><text class="inlink"/><g class="moveTool"/><g class="resizeTool"/><g class="portsTool"/> <g class="deleteTool"/></g>',
